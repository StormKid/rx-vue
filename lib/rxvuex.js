...
/*!********************************!*\
  !*** ./src/subject/subject.js ***!
  \********************************/
/*! exports provided: Subject, subject, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _store_pool__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../store.pool */ "./src/store.pool.js");
...
var vm = _store_pool__WEBPACK_IMPORTED_MODULE_3__["cache"].get(_constants__WEBPACK_IMPORTED_MODULE_4__["vmKey"]);
var singleSubject = null;
var Subject =
/*#__PURE__*/
function () {
  /**
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Subject, [{
    ...
    value: function initSingle() {
      ...
      self.singleSubject.prototype.subscribe = function subscribe(vue) {
        ...
        _store_pool__WEBPACK_IMPORTED_MODULE_3__["cache"].set(_constants__WEBPACK_IMPORTED_MODULE_4__["dataKey"], changeData);
      };
      /**
       * save value
       * 储存value
      ...
      self.singleSubject.prototype.next = function next(key, value) {
        _store_pool__WEBPACK_IMPORTED_MODULE_3__["cache"].set(key, value);
      };
      /**
       * clean cache
       * 清理缓存
      ...
      self.singleSubject.prototype.clear = function clear() {
        _store_pool__WEBPACK_IMPORTED_MODULE_3__["cache"].clear();
        _store_pool__WEBPACK_IMPORTED_MODULE_3__["cache"].set(_constants__WEBPACK_IMPORTED_MODULE_4__["vmKey"], vm);
      };
      /**
       * delete one value
       * 删除某个值
      ...
      self.singleSubject.prototype.remove = function remove(key) {
        _store_pool__WEBPACK_IMPORTED_MODULE_3__["cache"]["delete"](key);
      };
      /**
       * find one value
       * 获取某个值
      ...
      self.singleSubject.prototype.getValue = function getValue(key) {
        _store_pool__WEBPACK_IMPORTED_MODULE_3__["cache"].get(key);
      };
      /**
       * to test Api
       * 供给测试API
      ...
      self.singleSubject.prototype.getJson = function getJson() {
        return _store_pool__WEBPACK_IMPORTED_MODULE_3__["cache"].toJSON();
      };
    }
  }]);
