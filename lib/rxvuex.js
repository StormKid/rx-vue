...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  subject: _subject_subject__WEBPACK_IMPORTED_MODULE_1__["default"]
});
...
/*!********************************!*\
  !*** ./src/subject/subject.js ***!
  \********************************/
/*! exports provided: Subject, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var vm = _store_pool__WEBPACK_IMPORTED_MODULE_2__["cache"].get(_constants__WEBPACK_IMPORTED_MODULE_3__["vmKey"]);
var subject = null;
var Subject =
/*#__PURE__*/
function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Subject, [{
    ...
    value: function initSingle() {
       ...
       * 注册路由
       */
      subject.prototype.subscribe = function subscribe(vue) {
        if (vue.subject) {
          subject = vue.subject;
        } else {
          subject = new Subject();
        ...
        _store_pool__WEBPACK_IMPORTED_MODULE_2__["cache"].set(_constants__WEBPACK_IMPORTED_MODULE_3__["dataKey"], changeData);
        vue.prototype.subject = subject; // 双向绑定
      };
      /**
       * save value
       * 储存value
      ...
      subject.prototype.next = function next(key, value) {
        _store_pool__WEBPACK_IMPORTED_MODULE_2__["cache"].set(key, value);
      };
      /**
       * clean cache
       * 清理缓存
      ...
      subject.prototype.clear = function clear() {
        _store_pool__WEBPACK_IMPORTED_MODULE_2__["cache"].clear();
        _store_pool__WEBPACK_IMPORTED_MODULE_2__["cache"].set(_constants__WEBPACK_IMPORTED_MODULE_3__["vmKey"], vm);
      };
      /**
       * delete one value
       * 删除某个值
      ...
      subject.prototype.remove = function remove(key) {
        _store_pool__WEBPACK_IMPORTED_MODULE_2__["cache"]["delete"](key);
      };
      /**
       * find one value
       * 获取某个值
      ...
      subject.prototype.getValue = function getValue(key) {
        _store_pool__WEBPACK_IMPORTED_MODULE_2__["cache"].get(key);
      };
      /**
       * to test Api
       * 供给测试API
      ...
      subject.prototype.getJson = function getJson() {
        return _store_pool__WEBPACK_IMPORTED_MODULE_2__["cache"].toJSON();
      };
    }
  }]);
